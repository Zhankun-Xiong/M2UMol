...
from molepre import smiles2data
...
class DTIDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        ###########################################The part deleted is DrugBAN's molecular preprocess, which we have replaced with our molecular preprocess
        data = smiles2data(v_d)
        v_d = data
